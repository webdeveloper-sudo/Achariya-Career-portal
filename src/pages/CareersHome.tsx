  ...
  return (
    <div className="min-h-screen font-sans text-gray-900 overflow-x-hidden">
      ...
      <main className=" bg-white/70 container mx-auto">
        ...
        <section
          id="openings"
          className="text-center pt-16 pb-10 md:px-0 px-4 max-w-5xl mx-auto"
        >
          ...
          <p className=" text-gray-600">
            Join a multi-institutional education group dedicated to shaping
            future leaders through a strong ecosystem that spans Schools,
            Colleges, and Corporate divisions, fostering academic excellence,
            practical skills, and industry-ready professionals.
          </p>
        </section>

        {/* ================= CATEGORIES ================= */}
        <section id="categories" className="max-w-7xl mx-auto px-6 mb-12">
        ...
        {/* ================= TRUST STATS ================= */}
        <div className="bg-[#ffff] pt-5">
          <section className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            {[
              ...
              <a
                key={i}
                href={item.link}
                className="bg-[#ffff] border border-gray-400 rounded-xl  shadow-sm py-8 text-center hover:shadow-md transition"
              >
                <p className="text-4xl font-extrabold text-[#C72323]">
                  {loading ? "—" : item.value}
                </p>
        ...
        <section className="py-20 mb-16 text-center bg-gradient-to-r from-[#C72323] to-red-700 text-white">
        ...
        {/* ================= WHO WE ARE & WHY CHOOSE ACHARIYA ================= */}
        <section className="max-w-6xl mx-auto px-6 mb-12">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4">
              Who We Are
              <span className="text-[#C72323]"> !</span>
            </h2>
